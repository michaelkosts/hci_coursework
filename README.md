...
```text
hci_coursework/
├── index.html                     # Main portfolio page (cards for Tasks 1–6)
├── README.md                      # This file
├── activity-1-problem-definition/ # Activity 1 materials (problem, personas, scenarios, etc.)
├── activity-2-need-finding/       # Activity 2 materials (methods, data, requirements)
├── activity-3-design-alternatives/# Activity 3 materials (design options, low-fi prototypes)
